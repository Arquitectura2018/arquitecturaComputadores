...
//evaluo el if
0008 CMP %L0, %L1                      10000000101001000000000000010001                0X80A40011
000C BE, A, @else                      00100010100000000000000000011000                0X22800018

//cuando se cumple el if
0010 SRL, %L2,4 %O0                    10010001001101001010000000000100                0X9134A004
0014 BA, A, @fin                       00110000100000000000000000011100                0X3080001C

@else
0018 SLL %L1, 5, %O0                   10010001001011000110000000000101                0X912C6005
...
//vuelvo a main
0010 JMPL %07, 8, %G0		       10000001110000111110000000001000                0X81C3E008
0014 NOP 			       00000001000000000000000000000000                0X1000000

//main
//inicializo variables
0018 MOV 4, %I0                        10110000000100000010000000000100                0XB0102004
001C MOV 2, %I1                        10110010000100000010000000000010                0XB2102002
0020 SETHI, 4194288, $I2               00110101001111111111111111110000                0X353FFFF0
0024 OR %I2, 784, %I2                  10110100000101101010001100010000                0XB416A310

0028 CALL @test                        01000000000000000000000000000000                0X40000000
002C NOP			       00000001000000000000000000000000                0X1000000

//retorno x + 45
0030 ADD %IO, 45, %O0                  10010000000001100010000000101101                0X9006202D
```
...
//voy haciendo sucesion de sumas
//y actualizo el contador
...
0018	BA, a, @for1                   00110000100000000000000000001000                0X30800008

@endFor1
//vuelvo dos lineas abajo
//de donde me invocaron
001C	JMPL %07, 8, %G0               10000001110000111110000000001000                0X81C3E008
...
0040	ADD %L2, 1, %L2                10100100000001001010000000000001                0XA404A001
0044	BA, a, @for2                   00110000100000000000000000110000                0X30800030

@endFor2
//vuelvo una linea abajo de
//donde me invocaron
0048	JMPL %06, 4, %G0               10000001110000111010000000000100                0X81C3A004

//main
//inicializo variables
004C	MOV 2, %L0                     10100000000100000010000000000010                0XA0102002
0050	MOV 5, %L1                     10100010000100000010000000000101                0XA2102005
